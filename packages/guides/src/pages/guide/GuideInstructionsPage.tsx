    ...
    <div className="space-y-6">
      ...
      <article id="profile" className="card scroll-mt-28 space-y-6 [&>section+section]:border-t [&>section+section]:border-divider [&>section+section]:pt-6">
        ...
        <Step id="profile-about" number="4" title="Напишіть інформацію про себе">
          <p>
            ...
            варто обрати саме вас. Максимум 1000 символів.
          </p>
          ...
          <Callout tone="tip" title="Порада">
            ...
            щоб турист міг познайомитися з вами ще до бронювання. Посилання в описі на сайті не
            показуються — контакти вказуйте в блоці нижче.
          </p>
          </Callout>
        </Step>
      ...
      <article id="excursions" className="card scroll-mt-28 space-y-6 [&>section+section]:border-t [&>section+section]:border-divider [&>section+section]:pt-6">
        ...
        <Step id="exc-media" number="2" title="Вкладка «Медіа»">
          ...
          <SubStep title="2.2. Фото зберігаються одразу">
            <Callout tone="tip" title="Автозбереження">
              <p>
                Після обрізки фото галереї зберігається автоматично — кнопку «Зберегти» для них
        ...
        <Step id="exc-locations" number="5" title="Фото-локації на маршруті">
          ...
          <BulletList
            items={[
              ...
              'Перевірте відображення — фото збережеться автоматично.',
            ]}
          />
          <Callout tone="tip" title="Порада">
            <p>
