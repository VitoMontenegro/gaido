...
func defaultAboutContent() domain.AboutPageContent {
	return domain.AboutPageContent{
		HeroEyebrow: "Про Gaido",
		HeroTitle:   "Будь своїм серед своїх",
		HeroLead:    "Каталог українських гідів та авторських екскурсій — щоб легко знайти своїх у будь-якому місті світу.",
		Story: []string{
		...
		Belief:        "Ми віримо, що де б не жили українці, вони не повинні почуватися чужими. Нас багато, і ми можемо бути ближчими одне до одного.",
		AudienceTitle: "Для кого Gaido",
		AudienceLead:  "Gaido створена для українців у всьому світі — незалежно від того, де вони живуть, працюють, подорожують чи лише тимчасово перебувають.",
		Audience: []domain.AboutAudienceItem{
			{Title: "Для мандрівників", Description: "Щоб подорожі ставали цікавішими та теплішими — з гідами, маршрутами та рідною мовою."},
			{Title: "Для тих, хто живе за кордоном", Description: "Для українців, які вже давно оселилися за кордоном або щойно приїхали і шукають своїх."},
			{Title: "Для гідів", Description: "Щоб українські гіди були помітними й знаходили мандрівників, яким близька рідна мова."},
			{Title: "Для тих, хто шукає екскурсії", Description: "Авторські маршрути від місцевих — оберіть програму та звʼяжіться напряму."},
		},
		Disclaimer: "Gaido не надає екскурсійних послуг. Ми є інформаційною платформою, яка допомагає знайти гіда чи екскурсію і звʼязатися з автором безпосередньо.",
		Mission:    "Ми створюємо простір, де українці можуть бути помітними, знаходити одне одного та залишатися частиною своєї спільноти.",
