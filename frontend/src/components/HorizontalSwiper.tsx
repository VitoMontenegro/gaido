...
export default function HorizontalSwiper({
  children,
  desktopClassName = 'hidden gap-4 md:grid md:grid-cols-2 lg:grid-cols-4',
  ...
  return (
    <>
      <div className="md:hidden">
        <div className="-mx-5 overflow-x-auto overscroll-x-contain pb-1 [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
