      ...
      <div className="container-site">
        ...
        >
          ...
          <button
            ...
            onClick={() => void accept()}
            disabled={submitting}
            className="mb-0.5 flex h-[34px] w-full min-w-[111px] shrink-0 items-center justify-center rounded-[25px] bg-brand-500 text-[12px] font-medium text-white transition hover:bg-brand-700 disabled:opacity-60 sm:w-[111px] lg:text-sm"
          >
            Зрозуміло
          </button>
        </div>
